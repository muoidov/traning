...
namespace muoi.Web.Tests
{
    public abstract class muoiWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static muoiWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(muoiWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<muoiDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<muoiDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<muoiDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<muoiDbContext, Task<T>> func)
        {
            T result;
